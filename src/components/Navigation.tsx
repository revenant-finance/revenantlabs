    ...
    return (
        <>
            <div className="fixed top-0 right-0 z-50 flex flex-col items-end w-full max-w-lg gap-2 p-6 pointer-events-none">
                ...
                <AnimatePresence>
                    {open && (
                        <motion.div initial={{ x: '120%' }} animate={{ x: 0 }} exit={{ x: '120%' }} className="w-full max-w-xs p-6 space-y-4 border-2 shadow-2xl pointer-events-auto bg-neutral-900 border-neutral-800 rounded-2xl">
