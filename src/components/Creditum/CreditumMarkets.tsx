                        ...
                        <div className="space-y-8" id="market">
                            ...
                            <div className="space-y-4">
                                <button
                                    ...
                                    onClick={() => setShowDepositTool((_) => !_)}
                                >
                                        ...
                                        <SlideOpen className="space-y-2">
                                            <div className="flex flex-col gap-2 md:flex-row">
                                                <div className="flex-1 space-y-1">
                                                    <p className="text-xs font-medium">
                                                        Amount of {selectedMarket.symbol} to
                                                        deposit.
                                                    </p>
                                                    <Input
                                                        type="number"
                                                        value={depositInput}
                                                        onChange={onChangeAmountDeposit}
                                                    ...
                                                    <DataPoint
                                                        ...
                                                        value={`${
                                                            ...
                                                            newBorrowPercentDeposit < 9000000
                                                                ? `${newBorrowPercentDeposit.toFixed(
                                                                      2
                                                                  )}%`
                                                                : 'None'
                                                        }`}
                                            ...
                                            <ConnectWalletButton>
                                                <Button
                                                    ...
                                                    onClick={() => onDeposit()}
                                                    disabled={!depositInput && !borrowInput}
                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    ...
                                    <p className="opacity-50">
                                        Repay your cUSD loans and withdraw your{' '}
                                        {selectedMarket.symbol} back into your wallet.
                                    </p>
                                </button>
                                        ...
                                        <SlideOpen className="space-y-2">
                                            <div className="flex flex-col gap-2 md:flex-row">
                                                ...
                                                <div className="flex-1 space-y-1">
                                                    ...
                                                    <Input
                                                        type="number"
                                                        value={withdrawInput}
                                                        onChange={onChangeAmountWithdraw}
                                                ...
                                                <div className="p-4 bg-white rounded bg-opacity-10">
                                                    <DataPoint
                                                        ...
                                                        value={`${
                                                            ...
                                                            newBorrowPercentRepay &&
                                                            newBorrowPercentRepay > 0
                                                                ? `${newBorrowPercentRepay.toFixed(
                                                                      2
                                                                  )}%`
                                                                : 'None'
                                                        }`}
                                            ...
                                            <ConnectWalletButton>
                                                <Button
                                                    ...
                                                    onClick={() => onRepay()}
                                                    disabled={!withdrawInput && !repayInput}
